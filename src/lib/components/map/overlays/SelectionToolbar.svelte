...
<div class="flex gap-1 rounded-lg border bg-background/95 p-1 shadow-xs backdrop-blur-sm">
  <div class="flex items-center gap-1">
    ...
    <Tooltip.Root>
      <Tooltip.Trigger>
        <Button disabled={selectedCount === 0} variant="ghost" size="sm" class="cursor-pointer" onclick={onReveal}>
          <Eye class="h-4 w-4" />
        </Button>
      </Tooltip.Trigger>
    ...
    <Tooltip.Root>
      <Tooltip.Trigger>
        <Button disabled={selectedCount === 0} variant="ghost" size="sm" class="cursor-pointer" onclick={onHide}>
    ...
    <Tooltip.Root>
      <Tooltip.Trigger>
        <Button disabled={selectedCount === 0} variant="ghost" size="sm" class="cursor-pointer" onclick={onClear}>
