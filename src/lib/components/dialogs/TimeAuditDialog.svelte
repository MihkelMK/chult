...
<Dialog.Root {open}>
  ...
  <Dialog.Content class="flex max-h-[80vh] flex-col gap-2 sm:max-w-[800px]">
    <Dialog.Header class="mb-4">
      ...
      <Dialog.Description>View logs of when, why and by how much game time has changed.</Dialog.Description>
    </Dialog.Header>
      ...
      <Empty.Root>
        <Empty.Content>
          ...
          <Empty.Header>
            ...
            <Empty.Description>
              {filterType === 'all' ? 'No time changes have been recorded yet' : `No ${filterType} entries found`}
            </Empty.Description>
          </Empty.Header>
        </Empty.Content>
      </Empty.Root>
