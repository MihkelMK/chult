<script lang="ts">
  ...
  let { open = $bindable(), title, description, defaultTimeCost, onConfirm, onCancel }: Props = $props();
  ...
  <DialogContent class="z-60 sm:max-w-105">
    ...
    <div class="grid gap-4 py-4">
      <div class="grid grid-cols-4 items-center gap-4">
        ...
        <Input id="timeCost" type="number" step="0.5" min="0" bind:value={timeCost} class="col-span-3" />
      </div>
