import type { GameSessionResponse, MapMarkerResponse, PathStep, PlayerCampaignDataResponse, RevealedTile } from '$lib/types';
...
export class LocalStatePlayer extends LocalState {
  ...
  constructor(initialData: PlayerCampaignDataResponse, campaignSlug: string) {
    ...
    this.addEventListener('time:updated', (data) => super.handleTimeUpdated(data as { globalGameTime: number }));
