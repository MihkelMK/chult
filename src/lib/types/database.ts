...
export type MapMarkerResponse = Pick<
  MapMarker,
  'id' | 'x' | 'y' | 'type' | 'title' | 'content' | 'authorRole' | 'visibleToPlayers' | 'imagePath' | 'createdAt' | 'updatedAt'
>;
...
export type TimeAuditLogResponse = Pick<TimeAuditLog, 'id' | 'timestamp' | 'type' | 'amount' | 'actorRole' | 'notes'>;
