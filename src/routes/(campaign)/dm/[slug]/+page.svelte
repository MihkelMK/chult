			...
			<div class="flex items-start justify-between">
				...
				<div class="space-y-1 text-right text-sm text-gray-600">
					...
					<div class="flex items-center space-x-2">
						...
						<span
							>POIs: <strong>{data.mapMarkers.filter((m) => m.type === 'poi').length}</strong></span
						>
					</div>
					...
					<div class="flex items-center">
						...
						>
							<path
								...
								stroke-linejoin="round"
								stroke-width="2"
								d="M11 5H6a2 2 0 00-2 2v11a2 2 0 002 2h11a2 2 0 002-2v-5m-1.414-9.414a2 2 0 112.828 2.828L13 16H10v-3l8.586-8.586z"
							/>
						</svg>
						<span
							>Notes: <strong>{data.mapMarkers.filter((m) => m.type === 'note').length}</strong
							></span
						>
					</div>
				</div>
...
<div class="grid grid-cols-1 gap-6 md:grid-cols-2 lg:grid-cols-4">
	...
	>
		<div class="flex items-center">
			...
			<div class="ml-4">
				<h3 class="text-lg font-medium text-gray-900 group-hover:text-blue-600">Interactive Map</h3>
	...
	>
		<div class="flex items-center">
			...
			<div class="ml-4">
				<h3 class="text-lg font-medium text-gray-900 group-hover:text-purple-600">Game Sessions</h3>
	...
	<form action="?/toggleView" method="POST" class="contents">
		<button
			type="submit"
			class="group rounded-lg border border-gray-200 bg-white p-6 text-left shadow-sm transition-shadow hover:shadow-md"
		>
			<div class="flex items-center">
				<div class="flex-shrink-0">
					<svg
				...
				<div class="ml-4">
					...
					<p class="text-sm text-gray-600">See what your players see</p>
				</div>
			</div>
		</button>
	</form>
